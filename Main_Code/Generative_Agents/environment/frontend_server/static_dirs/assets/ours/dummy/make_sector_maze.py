...
def main():
    ...
    object2int = dict()
    with open('../matrix/special_blocks/sector_blocks.csv', newline='', encoding='cp949') as csvfile:
    ...
    with open('../matrix/maze/sector_maze.csv', 'w') as arena_file:
